            ...
            if (
              ...
              if (token.type != "access") {
                ...
                db.user
                  ...
                  .then((user) => {
                    link_account(user, profile, "Google")
                      .then((linked_user) => {
            ...
            register
              ...
              .catch((err) => {
                if (err === "Email already exists") {
                  // If user account already exists, link it to their Google account (also automatically verifies the user's email if necessary)
                  link_account_email(profile, "Google")
                    .then((linked_user) => {
                      return done(null, linked_user);
                    })
                    .catch((err) => {
